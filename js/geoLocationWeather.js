    		...
    		function onDeviceSuccess(location)
			{
				onDeviceReady("onDeviceSuccess");
    		...
    		function displayLocationWeather(data)
			{
				...
				/* Determine HTML Layout of the locationWeatherContent on the index page */
				/* The Weather Data will appear in this element */
				var element = document.getElementById('locationWeatherContent');
	    		element.innerHTML = '<div id="headingCity">'+ data.name + ' ' + data.sys.country +' </div>'+
	    		'<img src="images/weatherIcons/' + image + '.png" alt=" " />' +
	    		'<div id="headingSub">'+ data.weather[0].main + ' : ' + data.weather[0].description + '</div>' +
	    		'<div id="headingSub">Current Temp: ' + (data.main.temp - 273.15).toFixed(2) + '°C' + '</div>' +
	    		'<div id="headingSub">Max Temp: ' + (data.main.temp_max - 273.15).toFixed(2) + '°C' + '</div>' +
	    		'<div id="headingSub">Min Temp: ' + (data.main.temp_min - 273.15).toFixed(2) + '°C' + '</div>' +
	    		'<div id="headingSub">Wind Speed: ' + data.wind.speed + ' m / s' + '</div>' +
	    		'<div id="headingSub">Wind Direction: ' + data.wind.deg + '°' + '</div>' +
	    		'<div id="headingSub"><img src="images/weatherIcons/sunrise24x24.png"/> Sunrise :' + sunriseTime +
	    		'<div id="headingSub"><img src="images/weatherIcons/sunset24x24.png"/> SunSet : ' + sunSetTime ;
