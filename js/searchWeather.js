    		...
    		function displayCityWeather(data)
    		{
				...
				/* Determine HTML Layout of the cityWeatherContent on the index page */
				/* The Weather Data will appear in this element */
				var cityElement = document.getElementById('cityWeatherContent');
	    		cityElement.innerHTML =
	    		'<div id="headingCity">'+ data.name + ' ' + data.sys.country +' </div>'+
